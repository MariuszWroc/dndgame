...
public enum DefaultHero {
    SAVEROK {
        @Override
        public Hero getHero(Profession profession, Team team, List<Item> items) {
    ...
    public abstract Hero getHero(Profession profession, Team team, List<Item> items);
}
